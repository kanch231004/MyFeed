...
object InjectorUtils {
    ...
    fun provideFeedViewModelFactory(context: Context): FeedListVMFactory {
        val repository = getFeedRepository(context)
        return FeedListVMFactory(repository)
    }
